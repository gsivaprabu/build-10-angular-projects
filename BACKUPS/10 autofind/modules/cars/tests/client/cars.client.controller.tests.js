  ...
  describe('Cars Controller Tests', function () {
    ...
    describe('$scope.create()', function () {
      ...
      beforeEach(function () {
        ...
        sampleArticlePostData = new Cars({
          title: 'An Article about MEAN',
          content: 'MEAN rocks!'
        });
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (Cars) {
        // Set POST response
        $httpBackend.expectPOST('api/cars', sampleArticlePostData).respond(mockCar);
      ...
      it('should set scope.error if save error', function () {
        ...
        $httpBackend.expectPOST('api/cars', sampleArticlePostData).respond(400, {
